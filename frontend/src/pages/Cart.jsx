            ...
            <div key={i} className='p-1 rounded-lg'>
              <div className='flex items-center gap-x-3'>
                  <div className='flex items-start gap-6'>
                    <img src={productData.image[0]} alt='w'
                  ...
                  <div className='flex flex-col w-full'>
                    <div className='flexBetween'>
                      ...
                      <FaRegWindowClose onClick={() => updateQuantity(item._id, item.size , 0)} className='cla text-secondary cursor-pointer'/>
                    </div>
              ...
              <hr className='mx-auto h-[1px] w4/5 bg-gray-900/10 mt-2'></hr>
              </div>
          )
        })}
        </div>
