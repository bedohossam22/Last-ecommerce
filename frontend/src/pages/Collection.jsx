...
const applySorting = (productsList) => {
  switch(sortType){
    ...
    }, [products, category, subCategory, sortType , products , search , showSearch]);
           ...
           <h5 className='h5 mb-4'>Types</h5>
            <div  className='flex flex-col gap-2 text-sm font-light'>
              {["Topwear" , "Bottomwear" , "Winterwear"].map((subCat) => (
                <label onChange={(e) => toggleFilter(e.target.value,setSubCategory)} key={subCat} className='flex gap-2 medium-14 text-gray-30'>
